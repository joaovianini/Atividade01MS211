...
def falsaposicao(f,a,b,maxiter,epsilon,delta):
    a_v = [a]
    b_v = [b]
...
def printResults(f,a,b,maxiter,epsilon,delta):
    x,a,b,i,bool = falsaposicao(f,a,b,maxiter,epsilon,delta)
    f_v = list(map(f,x))
    if bool:
...
printResults(function,2,3,50,math.pow(10,-12),math.pow(10,-12))
